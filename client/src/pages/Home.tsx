...
export default function Home() {
  ...
  const recentActivity = previewMode ? activity : recentOrders.slice(0, 3).map((order) => ({ title: "Commande mise à jour", detail: `${order.id} · ${order.status}`, icon: ShoppingBag, color: "bg-[#eee8ff] text-[#6954c6]" }));
