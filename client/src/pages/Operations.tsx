...
function CreateForm({ type, onClose }: { type: SectionKey; onClose: () => void }) {
  ...
  const [values, setValues] = useState({ name: "", city: "", address: "", firstName: "", lastName: "", email: "", phone: "", category: "Vêtement", basePrice: "" });
